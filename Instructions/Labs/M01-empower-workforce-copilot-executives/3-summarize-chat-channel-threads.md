...
13. Le fil de conversation étant ouvert, sélectionnez l’icône **Ouvrir Copilot** dans le coin supérieur droit de la conversation.<br>
...
2.  Dans la discussion du canal, sélectionnez le lien sous la publication du canal pour développer les réponses et voir la conversation complète.
   ...
   ![Capture d’écran montrant une publication de canal immersif dans Teams avec l’icône Copilot en évidence.](../media/copilot-teams-replies-4974c937.png)
...
3.  Dans cette vue de publication de canal immersif, sélectionnez l’icône **Ouvrir le copilote du canal** dans le coin supérieur droit de la vue du canal.
   ...
   ![Capture d’écran montrant une publication de canal dans Teams avec l’option de réponse en évidence.](../media/copilot-teams-icon-replies-c03368a6.png)
